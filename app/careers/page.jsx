...
export const metadata = {
  title: 'Careers - AI Media',
  description:
    'Join AI Media and help build websites, SEO, content, automation, and reporting systems for AV and smart home integrators.',
};
          ...
          <div className="about-shell">
            ...
            <div className="about-card-grid">
              {VALUES.map((item, index) => (
                <article className="about-card card-hover" key={item.title}>
        ...
        <section className="about-section careers-roles" aria-labelledby="careers-roles-title">
          <div className="about-shell">
            ...
            <div className="careers-role-grid">
              {OPEN_ROLES.map((role) => (
                <article className="careers-role-card about-card card-hover" key={role.title}>
                  <div>
                    <span>{role.type}</span>
                    <h3>{role.title}</h3>
                    <p>{role.text}</p>
          ...
          <div className="about-shell">
            ...
            <div className="careers-process-list">
              {PROCESS.map((step, index) => (
                <article className="about-card careers-process-card" key={step}>
