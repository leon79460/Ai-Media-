...
const TEAM = [
  {
    ...
    text: "Josh is the founder of AI Media and the driving force behind the company's vision. With 17 years in the AV and smart home industry, he understands exactly what integrators need from a marketing partner. He leads strategy, sales, partnerships, and the standard of quality behind every client relationship.",
  },
  {
    name: 'Riduanul Islam Sayim',
    role: 'Project Manager',
    image: '/about/team-sophia.png',
    text: 'Sayim oversees project delivery from planning to completion. He keeps timelines clear, teams aligned, and client work moving forward smoothly. His role is to make sure every project is delivered with structure, quality, and a strong client experience.',
  },
  {
    name: 'Moddasir Billah Toufik',
    role: 'Chief Operating Officer & Creative Director',
    image: '/about/team-mason.png',
    text: "Toufik turns AI Media's vision into organized execution. He leads operations, systems, workflows, and internal strategy to make sure the team moves fast without losing quality. His focus is building the processes that help AI Media deliver smarter, cleaner, and more consistently.",
  },
  {
    name: 'Caleb Trevithick',
    role: 'Chief AI & Automation Officer',
    image: '/about/team-elena.png',
    text: "Caleb leads the AI systems and automation behind AI Media's delivery engine. He builds the tools, workflows, and technical infrastructure that help the team produce better work in less time while keeping every project efficient, scalable, and future-ready.",
  },
  {
    name: 'Ash Sams MD Tanvir Jahan',
    role: 'Full-Stack Web Developer',
    image: '/about/team-david.png',
    text: 'Tanvir supports AI Media\'s web development and technical execution across both frontend and backend projects. He builds clean, responsive, SEO-ready websites while also working on dashboard systems, backend modules, and SQL schema development. From user-facing pages to structured backend logic, he helps make every digital project fast, organized, scalable, and ready to support real business growth.',
  },
  {
    name: 'Leon Bhuiyan',
    role: 'WordPress & Framer Solutions Developer',
    image: '/about/team-michael.png',
    text: 'Leon builds polished, reliable websites across WordPress and Framer. His work brings designs to life with strong technical execution, clean structure, and attention to performance, helping clients launch websites that look premium and work smoothly.',
  },
];
